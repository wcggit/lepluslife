...
<section class="download" style="margin-top: -40%">
    ...
    <div>
        <div><img src="${resourceUrl}/frontRes/activity/share/img/le.jpg" alt=""></div>
    </div>
</section>
<section class="success">
...
//            'https://itunes.apple.com/cn/app/le-jia-sheng-huo/id1155893772?mt=8';
        } else {
            window.location.href = 'http://shouji.baidu.com/software/10041204.html';
        }
    }
</script>
